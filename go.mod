...
require (
	...
	github.com/wundergraph/cosmo/composition-go v0.0.0-20240404090137-207661436138 // indirect
	github.com/wundergraph/cosmo/router v0.0.0-20240404090137-207661436138 // indirect
