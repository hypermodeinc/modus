...
export class OpenAIChatInput {
   ...
   */
  @omitif((self: OpenAIChatInput) => self.modalities.length == 0)
  modalities: Modality[] = [];
  ...
  @omitif((self: OpenAIChatInput) => self.frequencyPenalty == 0.0)
   ...
   * @default false
   */
  @omitif((self: OpenAIChatInput) => self.logprobs == false)
  logprobs: bool = false;
   ...
   */
  @alias("max_tokens")
  @omitif((self: OpenAIChatInput) => self.maxTokens == 4096)
  maxTokens: i32 = 4096;
  ...
  @omitif((self: OpenAIChatInput) => self.maxCompletionTokens == 4096)
  maxCompletionTokens: i32 = 4096;

  /**
   * The number of completions to generate for each prompt.
   */
  @omitif((self: OpenAIChatInput) => self.n == 1)
  n: i32 = 1;
  ...
  @omitif((self: OpenAIChatInput) => self.presencePenalty == 0.0)
  ...
  @omitif((self: OpenAIChatInput) => self.responseFormat.type == 'text')
   ...
   */
  @omitif((self: OpenAIChatInput) => self.seed == -1)
  seed: i32 = -1;
   ...
   * @default 1.0
   */
  @omitif((self: OpenAIChatInput) => self.temperature == 1.0)
  temperature: f64 = 1.0;
   ...
   */
  @alias("top_p")
  @omitif((self: OpenAIChatInput) => self.topP == 1.0)
  topP: f64 = 1.0;
  ...
  @omitif((self: OpenAIChatInput) => self.parallelToolCalls == true || !self.tools || self.tools!.length == 0)
...
export class FunctionDefinition {
   ...
   * @default false
   */
  @omitif((self: FunctionDefinition) => self.strict == false)
  strict: bool = false;
...
export class AssistantMessage<T> extends RequestMessage {
   ...
   */
  @alias("tool_calls")
  @omitif((self: AssistantMessage<T>) => self.toolCalls.length == 0)
  toolCalls: ToolCall[] = [];
