...
require (
	github.com/hypermodeinc/modus/lib/manifest v0.0.0-20241010205742-db9f1540f70b
	github.com/hypermodeinc/modus/lib/wasmextractor v0.0.0-20241010205742-db9f1540f70b
)
